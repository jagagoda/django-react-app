This is a weather app that uses https://openweathermap.org/ API to display weather data for inputted city. Django framework is used to retrieve the data from Api. App's frontend is developed with React and styled-components. 
